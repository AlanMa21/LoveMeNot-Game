...
BREAD: Did the teacher accidently lock it on their way out?!
...
CHERRY: (Blushing) "I'm almost done with my work, just got to finish this last paragraph."
...
//End of Dialogue.
//Find the three keys and escape. Three glowing items appear on the screen in random locations in the classroom, Bread must achieve all the glowing keys and escape the locked door before the countdown finishes. 20 seconds, optional, can be changed during and after testing to see how well it will be. A the end of the timer or when Bread escapes, the screen fades to black.
//FADE TO BLACKS.
-> END